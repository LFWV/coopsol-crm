        ...
        content: [
            ...
            { text: "3. UNIDADES CONSUMIDORAS", style: 'boldText' },
            {
                table: {
                    ...
                    body: [
                        [ {text: 'UC', bold: true}, {text: 'Endereço', bold: true}, {text: '% Rateio', bold: true}, {text: 'Consumo (kWh)', bold: true}, {text: 'Desconto (%)', bold: true} ],
                        [ currentSimData.ucNumber || "Não Informado", currentSimData.address, '100%', `${currentSimData.kwh || 0}`, `${currentSimData.discountPercent || 0} %` ]
                    ]
                },
                margin: [0, 0, 0, 15]
            },
